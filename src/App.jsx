  ...
  return (
    <div className="App">
      ...
      <main className="mainBody">
        ...
        <section className="bg-[url('./assets/bg-simplify-section-mobile.svg')] md:bg-[url('./assets/bg-simplify-section-desktop.svg')]  flex flex-col md:flex-row justify-between items-center bg-brightRed p-10 md:p-20">
        ...
        <footer>
          <div className="flex flex-col-reverse md:flex-col gap-10 justify-center md:justify-start items-center w-full md:w-auto;">
            {footerLogo}
          ...
          <div className="mt-10 md:mt-0 flex flex-row justify-between w-full md:w-auto">
